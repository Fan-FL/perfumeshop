...
public class Order {
	...
	public Order(int orderId, String orderNum, Date orderTime, int orderStatus, String note, int userId,
	...
	public Order(String orderNum, Date orderTime, int orderStatus, String note, int userId, String sendPlace,
